                ...
                <div className="container">
                    <div className="blog-head">
                        ...
                        <Link className="see-all" to="/blog"><span className="see_all-icon">see all</span>                        
                            ...
                            <svg  width="35" height="18" viewBox="0 0 35 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.5 9H33.5M33.5 9L25.5 1M33.5 9L25.5 17" stroke="#5B24B3" strokeWidth="2"/>
                            </svg>
                        </Link>
                    </div>
                    <div className="blog-cards">
                        <div className="blog-cards_item">
                            ...
                            <a className="blog-item_link" href="https://medium.com/@opium.pro">
                                ...
                                <span className="blog-cards__med-note">Read on Medium</span>
                            </a>
